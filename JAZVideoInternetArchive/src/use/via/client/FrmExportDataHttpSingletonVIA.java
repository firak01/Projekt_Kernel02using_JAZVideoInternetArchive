 ...
 *  Durch Verwendung des Singleton-Patterns wird dieser Frame immer nur einmal ge�ffnet !!!
 ...
 *  sondern nebenl�ufig im main-Thread ausgef�hrt wird.
 *   
 * @author 0823
 *
 */
public class FrmExportDataHttpSingletonVIA extends KernelJFrameCascadedZZZ{
	...
	/**Falls ...Singleton.getInstance() zum Holen der Instanz genutzt wurde, so ist das die M�glichkeit anschliessend noch wichtige Paramter an das Singleton-Objekt zu �bertragen.
	 * @param objKernel
	 * @param frameParent
	 * @return boolean
	 *
	...
	public boolean launchCustom(){	
		...
		return false;  //Dadurch sollen die Komponenten die Gr��e des Frames bestimmen.
	}
