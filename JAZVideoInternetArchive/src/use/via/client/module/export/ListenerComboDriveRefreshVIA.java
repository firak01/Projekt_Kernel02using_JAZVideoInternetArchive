...
public class ListenerComboDriveRefreshVIA extends KernelUseObjectZZZ implements ActionListener, IEventBrokerUserZZZ, IPanelCascadedUserZZZ{
	...
	public ListenerComboDriveRefreshVIA(IKernelZZZ objKernel){
		super(objKernel);
	}
	
	public ListenerComboDriveRefreshVIA(IKernelZZZ objKernel, IPanelCascadedZZZ panelParent, KernelSenderComponentSelectionResetZZZ objEventSender ){
		super(objKernel);
	...
	public void actionPerformed(ActionEvent eventAction) {
		...
		//try{
			...
			//Gerade das ist beim Refresh nciht gew�nscht  if(sNew.equals(sOld)) break main; // DEN EVENT NICHT AUSF�HREN, wenn der gleiche Eintrag (das gleiche Laufwerk erneut ausgew�hlt wurde, statt dessen soll der Refresh Button verwendet werden)
